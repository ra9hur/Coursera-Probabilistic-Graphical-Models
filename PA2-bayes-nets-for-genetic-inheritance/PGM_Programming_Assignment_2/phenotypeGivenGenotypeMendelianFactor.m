...
Table for isDominant==1
    3:      |   1: |  3 AND 1:  | Explanation
  trait     |  AA  |      1     |  (because there is dominant allele and trait)
  no trait  |  AA  |      0     |  (there is dominant allele but no trait)
  trait     |  Aa  |      1     |  (because there is dominant allele and trait)
  no trait  |  Aa  |      0     |  (there is dominant allele but no trait)
  trait     |  aa  |      0     |  (there is no dominant allele)
  no trait  |  aa  |      1     |  (???)

P(T|dominant) = 1
P(T|~dominant) = 0

from these two, I can write

P(~T|dominant) = 0, because P(T|dominant) + P(~T|dominant) = 1
P(~T|~dominant) = 1, because P(T|~dominant) + P(~T|~dominant) = 1  
